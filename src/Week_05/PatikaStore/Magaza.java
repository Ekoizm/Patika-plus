...
public class Magaza {
    ...
    public  void urunListele(){
        ...
        for (Urun urun : cepTelefonlari) {
            System.out.format("| %-2d | %-30s | %-9.1f TL | %-9s | %-10d | %-6.1f | %-9d | %-9.1f | %-9d | %-9s |\n", urun.getId(), urun.getUrunAdi(), urun.getBirimFiyat(), urun.getMarka().getName(), urun.getDepolama(), urun.getEkranBoyutu(), urun.getKamera(), urun.getPilGucu(), urun.getRam(), urun.getRenk());
        }
        System.out.println("--------------------------------------------------------------------------------------------------------------------------------------");
